...
ndeath106n12<-read_excel("死亡报告卡一览列表12月106（非沪籍).xls")
ndeath107n12<-read_excel("死亡报告卡一览列表12月107（非沪籍）.xls")
ndeath109n12<-read_excel("死亡报告卡一览列表12月109（非沪籍）.xlsx")
ndeath110n12<-read_excel("死亡报告卡一览列表12月110（非沪籍）.xls")
ndeath112n12<-read_excel("死亡报告卡一览列表12月112(非沪籍).xls")
ndeath113n12<-read_excel("死亡报告卡一览列表12月113（非沪籍）.xls")
ndeath114n12<-read_excel("死亡报告卡一览列表12月114（非沪籍）.xls")
ndeath115n12<-read_excel("死亡报告卡一览列表12月115（非沪籍）.xlsx")
ndeath116n12<-read_excel("死亡报告卡一览列表12月116（非沪籍）.xls")
ndeath117n12<-read_excel("死亡报告卡一览列表12月117（非沪籍）.xls")
ndeath118n12<-read_excel("死亡报告卡一览列表12月118（非沪籍）.xlsx")
ndeath120n12<-read_excel("死亡报告卡一览列表12月120（非沪籍）.xls")
ndeath151n12<-read_excel("死亡报告卡一览列表12月151（非沪籍）.xls")
...
death106h12<-read_excel("死亡报告卡一览列表12月106（沪籍）.xls",col_types ="text")
death107h12<-read_excel("死亡报告卡一览列表12月107（沪籍）.xls",col_types ="text")
death109h12<-read_excel("死亡报告卡一览列表12月109（沪籍）.xlsx",col_types ="text")
death110h12<-read_excel("死亡报告卡一览列表12月110（沪籍）.xls",col_types ="text")
death112h12<-read_excel("死亡报告卡一览列表12月112(沪籍).xls",col_types ="text")
death112h12ne<-read_excel("死亡报告卡一览列表12月112(沪籍)（不含儿福院）.xlsx",col_types ="text")
death113h12<-read_excel("死亡报告卡一览列表12月113（沪籍）.xls",col_types ="text")
death114h12<-read_excel("死亡报告卡一览列表12月114（沪籍）.xls",col_types ="text")
death115h12<-read_excel("死亡报告卡一览列表12月115（沪籍）.xlsx",col_types ="text")
death116h12<-read_excel("死亡报告卡一览列表12月116（沪籍）.xls",col_types ="text")
death117h12<-read_excel("死亡报告卡一览列表12月117（沪籍）.xls",col_types ="text")
death118h12<-read_excel("死亡报告卡一览列表12月118（沪籍）.xlsx",col_types ="text")
death120h12<-read_excel("死亡报告卡一览列表12月120（沪籍）.xls",col_types ="text")
death151h12<-read_excel("死亡报告卡一览列表12月151（沪籍）.xls",col_types ="text")
